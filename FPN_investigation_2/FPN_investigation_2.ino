...
num_leading_zeros = 0;                                                //Determine the number of leadig zeros (i.e. .005)
...
/********************************************************************************************************/
long decimal_to_binary(long num,int precision, char expt_3){            //Takes decimal points as integer number
...
/********************************************************************************************************/
void binary_points_to_decimal(long binary_points, int expt_2, int Num_dps){
long denominator = 1;                                                       
...
if (expt_2 >= -4)                                                           
{denominator = (unsigned long)0x80000000 >> (8 + expt_2);                   //Fails for shifts of less than 4
remainder = binary_points;}
else
{denominator = (unsigned long)0x80000000 >> (4);                            //If the exponent is less than -4
remainder = binary_points >> -expt_2 - 4;}                                  //we must also shift the binary points
