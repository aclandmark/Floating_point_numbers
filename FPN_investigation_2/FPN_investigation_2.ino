...
binary_places = decimal_to_binary(RHS_of_dp, 24);                   //Convert the integer number to 24 binary places 
...
/********************************************************************************************************/
long decimal_to_binary(long num,int precision){                         //Takes decimal points as integer number
