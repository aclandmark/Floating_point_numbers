...
/*********************************************************************************************************************************/
unsigned long Real_Num_to_FPN(char * array){
...
/*********************************************************************************************************************************/
void FPN_print_out(unsigned long FPN){
...
Scientific_num_from_KBD(array,&sign);                       //Enter number of decimal places required
num_decimal_places = atol(array);

expt_2 = ((FPN >> 23) & 0x1FF) - 127;                             //Recover the exponent
ltoa(expt_2, array, 10);
Serial.write("\r\nTwo's exponent is  ");
Serial.write(array);
